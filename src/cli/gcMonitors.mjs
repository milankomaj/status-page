...
getKvMonitors(kvMonitorsKey)
  .then(async (kvMonitors) => {
    ...
    console.log("👉 configMonitors:", configMonitors.length)
    console.log("👉 Object.keys(stateMonitors.monitors):", Object.keys(stateMonitors.monitors).length)
    const yaml_kv_monitors = (configMonitors.length === Object.keys(stateMonitors.monitors).length)
    console.log("👉 yaml_kv_monitors:", yaml_kv_monitors)
